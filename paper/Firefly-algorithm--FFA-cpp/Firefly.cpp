...
int main(int argc, char* argv[]) {
    ...
    cout << "n:"<<n<< " D:"<<D<< " MaxGeneration:"<<MaxGeneration<< " alpha:"<<alpha<< " betamin:"<< betamin<< " gama:"<< gama<< endl;
...
// g++ Firefly.cpp -o firefly
// ./firefly -n20 -d50 -g3000 -a0.5 -b0.2 -c1.0
