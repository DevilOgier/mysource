...
static void wr_done(io_context_t ctx, struct iocb *iocb, long res, long res2)
{
   ...
   if (res != iocb->u.c.nbytes) {
	fprintf(stderr, "write missed bytes expect %d got %d", iocb->u.c.nbytes, res2);
	exit(1);
   }
   --tocopy;
   --busy;
...
// gcc aiocp.c -o aiocp -laio
// ./aiocp /samba/ubuntu-16.04.1-desktop-amd64.iso  /dev/zero
